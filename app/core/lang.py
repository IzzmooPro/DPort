...
TR = {
    ...
    "update_active_blocked": "Güncelleme için önce Varsayılana Dönün. Güncelleme iptal edildi.",
...
EN = {
    ...
    "update_active_blocked": "Restore Defaults before updating. The update was cancelled.",
